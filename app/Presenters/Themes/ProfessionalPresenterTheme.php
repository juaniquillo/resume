...
final class ProfessionalPresenterTheme implements PresenterTheme
{
    ...
    {
        return [
            'professional' => 'downloads-container',
        ];
    }
    ...
    {
        return [
            'professional' => 'basics-inner-container',
        ];
    }
    ...
    {
        return [
            'professional' => 'summary-inner-container',
        ];
    }
    ...
    {
        return [
            'professional' => 'work-inner-container',
        ];
    }
    ...
    {
        return [
            'professional' => 'volunteers-inner-container',
        ];
    }
    ...
    {
        return [
            'professional' => 'education-inner-container',
        ];
    }
    ...
    {
        return [
            'professional' => 'awards-inner-container',
        ];
    }
    ...
    {
        return [
            'professional' => 'certificates-inner-container',
        ];
    }
    ...
    {
        return [
            'professional' => 'publications-inner-container',
        ];
    }
    ...
    {
        return [
            'professional' => 'skills-inner-container',
        ];
    }
    ...
    {
        return [
            'professional' => 'languages-inner-container',
        ];
    }
    ...
    {
        return [
            'professional' => 'interests-inner-container',
        ];
    }
    ...
    {
        return [
            'professional' => 'references-inner-container',
        ];
    }
    ...
    {
        return [
            'professional' => 'projects-inner-container',
        ];
    }
    ...
    {
        return [
            'professional' => 'downloads-inner-container',
        ];
    }
    ...
    {
        return ['professional' => 'section-title'];
    }

    public function sectionInnerThemes(): array
    {
        return ['professional' => 'section-inner'];
    }

    public function itemTitleThemes(): array
    {
        return ['professional' => 'item-title'];
    }

    public function itemContainerThemes(): array
    {
        return ['professional' => 'item-container'];
    }

    public function itemDetailsThemes(): array
    {
        return ['professional' => 'item-details'];
    }
    ...
    {
        return ['professional' => 'contact-container'];
    }

    public function badgeContainerThemes(): array
    {
        return ['professional' => 'badge-container'];
    }

    public function contactInnerContainerThemes(): array
    {
        return ['professional' => 'contact-inner-container'];
    }

    public function contactItemThemes(): array
    {
        return ['professional' => 'contact-item'];
    }
    ...
    {
        return ['professional' => 'image-container'];
    }
    ...
    {
        return ['professional' => 'keyword-badge'];
    }

    public function socialBadgeThemes(): array
    {
        return ['professional' => 'social-badge'];
    }

    public function dateThemes(): array
    {
        return ['professional' => 'date'];
    }

    public function subTitleThemes(): array
    {
        return ['professional' => 'subtitle'];
    }
    ...
    {
        return [
            'professional' => 'cover-letter-container',
        ];
    }
