...
use App\Cruds\Schema\Awards\Renderers\AwardsLivewireTableRenderer;
...
class AwardsTable extends Component
{
    ...
    private function crud()
    {
        return AwardsCrud::build(
            tableRenderer: AwardsLivewireTableRenderer::make(),
        );
    }
    ...
    {
        return view('livewire.resume.awards.awards-table')
