...
use App\Cruds\Schema\Interests\Renderers\InterestsLivewireTableRenderer;
...
class InterestsTable extends Component
{
    ...
    private function crud()
    {
        return InterestsCrud::build(
            tableRenderer: InterestsLivewireTableRenderer::make(),
        );
    }
    ...
    {
        return view('livewire.resume.interests.interests-table')
