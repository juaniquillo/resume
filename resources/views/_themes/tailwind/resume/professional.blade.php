...
return [
    ...
    'container' => 'mx-auto max-w-5xl px-6 md:px-10 py-12 bg-white text-gray-800 shadow-xl rounded-2xl border border-gray-200 dark:bg-zinc-900 dark:text-zinc-100 dark:border-zinc-800 grid grid-cols-1 md:grid-cols-3 gap-8',
    ...
    'image-container' => 'mb-6 flex justify-center md:justify-start',
    'image' => 'w-32 h-32 rounded-full object-cover border-4 border-white shadow-md dark:border-zinc-700',
    'name' => 'text-2xl md:text-3xl font-bold tracking-tight text-gray-900 dark:text-white mb-1',
    'label' => 'text-sm md:text-base font-semibold text-sky-600 dark:text-sky-400 mb-6',
    
    'contact-container' => 'flex flex-col gap-3 text-sm text-gray-600 dark:text-zinc-300 w-full border-t border-zinc-200 dark:border-zinc-700 pt-6 mt-4',
    'contact-inner-container' => '',
    
    'links' => 'text-gray-700 dark:text-zinc-200 hover:text-sky-600 dark:hover:text-sky-400 transition-colors underline truncate',
    'contact-item' => 'flex items-center gap-3 font-medium',
    'icon' => 'size-4 text-sky-600 dark:text-sky-400 shrink-0',
    
    'section' => 'mb-8 last:mb-0 bg-white dark:bg-zinc-900',
    'section-title' => 'text-lg font-bold text-gray-900 dark:text-white mb-4 uppercase tracking-wider border-b-2 border-sky-600 dark:border-sky-500 pb-1.5 flex items-center gap-2',
    'section-inner' => '',
    ...
    'skills-container' => '',
    'languages-container' => 'flex flex-wrap gap-2',
    'interests-container' => '',
    ...
    'item-title' => 'text-base md:text-lg font-bold text-gray-900 dark:text-white',
    'item-details' => 'text-xs md:text-sm font-medium text-gray-500 dark:text-zinc-400 mb-2 flex flex-wrap gap-x-4 gap-y-1',
    ...
    'date' => 'text-gray-500 dark:text-zinc-400 font-medium',
    'subtitle' => 'text-sm font-semibold text-gray-800 dark:text-zinc-200',
];
