...
return [
    ...
    'container' => 'mx-4 md:mx-auto max-w-5xl px-4 md:px-8 py-14 md:py-18 bg-zinc-900 text-white shadow-[10px_10px_0px_0px_rgba(255,255,0,1)] md:shadow-[20px_20px_0px_0px_rgba(255,255,0,1)] my-6 md:my-6 border-4 border-black dark:bg-black dark:border-zinc-800',
    ...
    'name' => 'mt-6 text-4xl md:text-6xl lg:text-7xl font-black uppercase tracking-tighter leading-[0.85] mt-2 break-words',
    'label' => 'text-lg md:text-2xl font-bold bg-yellow-400 text-black px-4 py-1 inline-block uppercase italic tracking-widest mt-2 mt-6',
    ...
    'section' => 'mt-12 md:mt-24',
    'section-title' => 'text-2xl md:text-5xl font-black uppercase tracking-tighter bg-white text-black px-4 md:px-6 py-2 inline-block transform -rotate-2',
    'section-inner' => 'mt-4',

    'summary' => 'text-xl md:text-2xl leading-tight font-medium text-zinc-300 max-w-4xl',

    'basics-container' => 'flex flex-col items-center md:items-start border-b-8 border-yellow-400 pb-12',
    'name-container' => '',
    'summary-container' => '',
    'work-container' => '',
    ...
    'downloads-inner-container' => 'mt-4 md:mt-6',

    'item-container' => 'mt-8 md:mt-16 relative group',
    'item-title' => 'text-2xl md:text-4xl font-extrabold uppercase tracking-tight text-white mt-2 group-hover:text-yellow-400 transition-colors break-words',
    'item-details' => 'text-yellow-400 mt-4 md:mt-6 text-base md:text-lg font-bold uppercase tracking-widest flex flex-wrap gap-x-4 md:gap-x-6 gap-y-2 items-center',
    ...
    'badge-container' => 'self-center mt-4 flex flex-wrap gap-2',
    ...
    'subtitle' => 'text-xl md:text-2xl font-bold text-white uppercase tracking-tight',
];
