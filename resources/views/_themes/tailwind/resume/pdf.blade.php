...
return [
    ...
    'basics-container' => 'border-b-2 border-gray-100',
    'name-container' => '',
    ...
    'name' => 'text-4xl font-bold tracking-tight text-gray-900 mt-1',
    'label' => 'text-xl font-medium text-gray-600 mt-4',
    
    'contact-container' => 'mt-2 flex flex-wrap gap-x-6 gap-y-1 text-sm text-gray-600',
    ...
    'section' => 'mt-6',
    'section-title' => 'text-sm font-bold text-gray-900 mt-4 uppercase tracking-[0.2em] border-b border-gray-200 pb-2',
    'section-inner' => '',

    'summary-container' => '',
    'summary' => 'text-[15px] leading-relaxed text-gray-700',
    ...
    'item-container' => 'mt-4',
    'item-title' => 'text-[16px] font-bold text-gray-900 ',
    'item-details' => 'text-gray-500 mt-2 text-sm font-medium flex flex-wrap gap-x-4 items-center',
    ...
    'subtitle' => 'text-[15px] font-semibold text-gray-800 mt-1',
];
