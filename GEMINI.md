...
*   **Font:** Used "Space Mono" from Google Fonts to achieve a technical, retro, and pixelated aesthetic.
...
*   **Icons:** Integrated [Pixel Icon Library](https://pixeliconlibrary.com/) to complement the Retro-Modern aesthetic.
*   **Design System:** Created `DESIGN.md` to document the design philosophy, typography, color palette, and UI components. This serves as the source of truth for the site's visual identity.
